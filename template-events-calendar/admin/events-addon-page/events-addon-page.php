    ...
    class cool_plugins_events_addons {
         ...
         */
            ...
            function init_plugins_dasboard_page(){
                ...
                add_menu_page(
                    esc_html__( 'Events Addons', 'template-events-calendar' ),
                    esc_html__( 'Events Addons', 'template-events-calendar' ),
                    'manage_options',
                    $this->main_menu_slug,
                ...
                add_submenu_page(
                    $this->main_menu_slug,
                    esc_html__( 'Dashboard', 'template-events-calendar' ),
                    esc_html__( 'Dashboard', 'template-events-calendar' ),
                    'manage_options',
                    $this->main_menu_slug,
                    array( $this, 'displayPluginAdminDashboard' ),
            ...
            public function get_plugin_demo_docs_urls( $plugin_slug, $is_pro_plugin = false ) {
                ...
                $demo_url = 'https://eventscalendaraddons.com/demos/?utm_source=ect_plugin&utm_medium=inside&utm_campaign=demo&utm_content=dashboard';
                $docs_url = 'https://eventscalendaraddons.com/docs/?utm_source=ect_plugin&utm_medium=inside&utm_campaign=docs&utm_content=dashboard';
            ...
            private function render_plugin_card_demo_docs_links( $prefix, $plugin_slug, $is_pro_plugin ) {
                ...
                <div class="<?php echo esc_attr( $prefix ); ?>-card-links">
                    <a href="<?php echo esc_url( empty($urls['demo']) ? 'https://eventscalendaraddons.com/demos/?utm_source=ect_plugin&utm_medium=inside&utm_campaign=demo&utm_content=dashboard' : $urls['demo'] ); ?>" target="_blank" rel="noopener" title="<?php esc_attr_e( 'View Demo', 'template-events-calendar' ); ?>">
                        ...
                        <?php esc_html_e( 'Demo', 'template-events-calendar' ); ?>
                    </a>
                    <a href="<?php echo esc_url( empty($urls['docs']) ? 'https://eventscalendaraddons.com/docs/?utm_source=ect_plugin&utm_medium=inside&utm_campaign=docs&utm_content=dashboard' : $urls['docs'] ); ?>" target="_blank" rel="noopener" title="<?php esc_attr_e( 'Documentation', 'template-events-calendar' ); ?>">
                        ...
                        <?php esc_html_e( 'Docs', 'template-events-calendar' ); ?>
                    </a>
                </div>
                <?php
            }
            ...
            function render_plugin_card($prefix, $plugin, $type = 'activated'){
                ...
                <div class="<?php echo esc_attr($prefix); ?>-card">
                    <?php if ( ! empty( $has_update ) ) : ?>
                        <div title="<?php echo esc_attr__( 'Update available', 'template-events-calendar' ); ?>" class="<?php echo esc_attr($prefix); ?>-pulse-wrapper"></div>
                        <div title="<?php echo esc_attr__( 'Update available', 'template-events-calendar' ); ?>" class="<?php echo esc_attr($prefix); ?>-notification-dot"></div>
                    <?php endif; ?>
                    
                    <?php if ( $is_pro_plugin ) : ?>
                        <span class="<?php echo esc_attr($prefix); ?>-badge <?php echo esc_attr($prefix); ?>-badge-premium"><?php echo esc_html__( 'Pro', 'template-events-calendar' ); ?></span>
                    <?php endif; ?>
                    ...
                    <div class="<?php echo esc_attr($prefix); ?>-info">
                        ...
                        <?php if ( $type === 'activated' ) : ?>
                            <div class="<?php echo esc_attr($prefix); ?>-badge-group">
                                <div class="<?php echo esc_attr($prefix); ?>-active-update">
                                    <span class="<?php echo esc_attr($prefix); ?>-badge <?php echo esc_attr($prefix); ?>-badge-active"><?php echo esc_html__( 'Active', 'template-events-calendar' ); ?></span>
                        ...
                        <?php elseif ( $type === 'available' ) : ?>
                            <div class="<?php echo esc_attr($prefix); ?>-card-footer">
                                ...
                                >
                                    <?php echo $needs_activation ? esc_html__( 'Activate Now', 'template-events-calendar' ) : esc_html__( 'Install Now', 'template-events-calendar' ); ?>
                                </button>
                                <?php $this->render_plugin_card_demo_docs_links( $prefix, $plugin_slug, $is_pro_plugin ); ?>
                            </div>
                        <?php elseif ( $type === 'pro' ) : ?>
                            <div class="<?php echo esc_attr($prefix); ?>-card-footer">
                                ...
                                <a href="<?php echo esc_attr( $buy_link ); ?>"
                                   ...
                                   class="button <?php echo esc_attr($prefix); ?>-button-primary <?php echo esc_attr($prefix); ?>-btn-buy">
                                    <?php echo esc_html__( 'Buy Pro', 'template-events-calendar' ); ?>
                                </a>
            ...
            function enqueue_required_scripts(){
                ...
                if($current_page == $this->main_menu_slug ){
                    ...
                    wp_enqueue_script( 'cool-plugins-events-addon', ECT_PLUGIN_URL .'admin/events-addon-page/assets/js/script.js', array('jquery'), ECT_VERSION, true);
                    ...
                    wp_localize_script( 'cool-plugins-events-addon', 'cp_events', array(
                        ...
                        'prefix'         => 'ect',
                        'activated_label' => esc_html__( 'Activated', 'template-events-calendar' )
                    ));
                }
            }
